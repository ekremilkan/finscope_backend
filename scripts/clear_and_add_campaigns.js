/**
 * Local MongoDB'ye 10 Kampanya Ekleme Scripti
 */
...
async function clearAndAddCampaigns() {
  try {
    ...
    const campaignData = [
      ...
      },
      {
        ...
        segments: [
          { name: 'A', reward: 180, maxParticipants: 40, currentParticipants: 0, description: 'NFT koleksiyoncuları' },
          { name: 'B', reward: 120, maxParticipants: 80, currentParticipants: 0, description: 'NFT deneyimi olan kullanıcılar' },
          { name: 'C', reward: 80, maxParticipants: 150, currentParticipants: 0, description: 'NFT\'ye yeni başlayanlar' }
        ],
      ...
      },
      {
        ...
        segments: [
          { name: 'A', reward: 160, maxParticipants: 60, currentParticipants: 0, description: 'Layer 2 deneyimi olan kullanıcılar' },
          { name: 'B', reward: 110, maxParticipants: 120, currentParticipants: 0, description: 'Layer 2 kullanımı olan kullanıcılar' },
          { name: 'C', reward: 70, maxParticipants: 200, currentParticipants: 0, description: 'Layer 2\'ye yeni başlayanlar' }
        ],
      ...
      },
      {
        ...
        segments: [
          { name: 'A', reward: 140, maxParticipants: 45, currentParticipants: 0, description: 'GameFi deneyimi olan oyuncular' },
          { name: 'B', reward: 90, maxParticipants: 90, currentParticipants: 0, description: 'GameFi\'ye ilgi duyan kullanıcılar' },
          { name: 'C', reward: 60, maxParticipants: 180, currentParticipants: 0, description: 'GameFi\'ye yeni başlayanlar' }
        ],
      ...
      },
      {
        ...
        segments: [
          { name: 'A', reward: 170, maxParticipants: 35, currentParticipants: 0, description: 'Bridge deneyimi olan kullanıcılar' },
          { name: 'B', reward: 130, maxParticipants: 70, currentParticipants: 0, description: 'Bridge kullanımı olan kullanıcılar' },
          { name: 'C', reward: 90, maxParticipants: 140, currentParticipants: 0, description: 'Bridge\'e yeni başlayanlar' }
        ],
      ...
      },
      {
        ...
        segments: [
          { name: 'A', reward: 190, maxParticipants: 30, currentParticipants: 0, description: 'Validator deneyimi olan kullanıcılar' },
          { name: 'B', reward: 140, maxParticipants: 60, currentParticipants: 0, description: 'Staking deneyimi olan kullanıcılar' },
          { name: 'C', reward: 100, maxParticipants: 120, currentParticipants: 0, description: 'Staking\'e yeni başlayanlar' }
        ],
      ...
      },
      {
        ...
        segments: [
          { name: 'A', reward: 160, maxParticipants: 40, currentParticipants: 0, description: 'DAO deneyimi olan kullanıcılar' },
          { name: 'B', reward: 110, maxParticipants: 80, currentParticipants: 0, description: 'DAO\'ya katılım deneyimi olan kullanıcılar' },
          { name: 'C', reward: 80, maxParticipants: 160, currentParticipants: 0, description: 'DAO\'ya yeni başlayanlar' }
        ],
      ...
      },
      {
        ...
        segments: [
          { name: 'A', reward: 200, maxParticipants: 50, currentParticipants: 0, description: 'Lending deneyimi olan kullanıcılar' },
          { name: 'B', reward: 150, maxParticipants: 100, currentParticipants: 0, description: 'Lending kullanımı olan kullanıcılar' },
          { name: 'C', reward: 100, maxParticipants: 200, currentParticipants: 0, description: 'Lending\'e yeni başlayanlar' }
        ],
      ...
      },
      {
        ...
        segments: [
          { name: 'A', reward: 180, maxParticipants: 45, currentParticipants: 0, description: 'DEX deneyimi olan kullanıcılar' },
          { name: 'B', reward: 130, maxParticipants: 90, currentParticipants: 0, description: 'DEX kullanımı olan kullanıcılar' },
          { name: 'C', reward: 90, maxParticipants: 180, currentParticipants: 0, description: 'DEX\'e yeni başlayanlar' }
        ],
      ...
      },
      {
        ...
        segments: [
          { name: 'A', reward: 220, maxParticipants: 25, currentParticipants: 0, description: 'dApp geliştirme deneyimi olan kullanıcılar' },
          { name: 'B', reward: 160, maxParticipants: 50, currentParticipants: 0, description: 'Web3 deneyimi olan kullanıcılar' },
          { name: 'C', reward: 110, maxParticipants: 100, currentParticipants: 0, description: 'Web3\'e yeni başlayanlar' }
        ],
        ...
        content: [
          {
            ...
            itemVideo: '',
            itemTitle: campaignData[i].title + ' - Bölüm 1',
